...
function(e, t) {
	...
	var i = '<div class="mui-dtpicker" data-type="datetime">';
	i += '	<div class="mui-dtpicker-header">';
	i += '		<button data-id="btn-cancel" class="mui-btn">取消</button>';
	i += '		<button data-id="btn-ok" class="mui-btn mui-btn-blue">确定</button>';
	i += '	</div>';
	i += '	<div class="mui-dtpicker-title">';
	i += '		<h5 data-id="title-y">年</h5>';
	i += '		<h5 data-id="title-m">月</h5>';
	i += '		<h5 data-id="title-d">日</h5>';
	i += '		<h5 data-id="title-h">时</h5>';
	i += '		<h5 data-id="title-i">分</h5>';
	i += '	</div>';
	i += '	<div class="mui-dtpicker-body">';
	i += '		<div data-id="picker-y" class="mui-picker">';
	i += '  		<div class="mui-picker-inner">';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-ft"></div>';
	i += '				<ul class="mui-pciker-list"></ul>';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-bg"></div>';
	i += '			</div>';
	i += '		</div>';
	i += '		<div data-id="picker-m" class="mui-picker">';
	i += '			<div class="mui-picker-inner">';
	i += '			<div class="mui-pciker-rule mui-pciker-rule-ft"></div>';
	i += '				<ul class="mui-pciker-list"></ul>';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-bg"></div>';
	i += '			</div>';
	i += '		</div>';
	i += '		<div data-id="picker-d" class="mui-picker">';
	i += '			<div class="mui-picker-inner">';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-ft"></div>';
	i += '				<ul class="mui-pciker-list"></ul>';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-bg"></div>';
	i += '			</div>';
	i += '		</div>';
	i += '		<div data-id="picker-h" class="mui-picker">';
	i += '			<div class="mui-picker-inner">';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-ft"></div>';
	i += '				<ul class="mui-pciker-list"></ul>';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-bg"></div>';
	i += '			</div>';
	i += '		</div>';
	i += '		<div data-id="picker-i" class="mui-picker">';
	i += '			<div class="mui-picker-inner">';
	i += '				<div class="mui-pciker-rule mui-pciker-rule-ft"></div>';
	i += '					<ul class="mui-pciker-list"></ul>';
	i += '					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>';
	...
	e.DtPicker = e.Class.extend({
		...
		_createMinutes: function(e) {
			...
			if (!!i.minutesInterval) m = parseInt(i.minutesInterval);
			for (var r = 0; 59 >= r; r += m) {
				var s = t._fill(r);
				n.push({
					text: s,
					value: s
