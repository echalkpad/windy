...
var highline={
	...
	,animation_:function(num){
		switch(num){
			...
			setTimeout(function(){ $("#cloudLeft").addClass("img3_ani"); },time);	
			setTimeout(function(){ $("#cloudRight").addClass("img4_ani"); },time);	
			setTimeout(function(){ $("#rocket").addClass("img5_ani"); },time);	
			setTimeout(function(){ $("#cont2_img6,#cont2_img7").addClass("com_ani_scale_1"); },time);	
			setTimeout(function(){ $("#cont2_img6").addClass("img6_ani"); },time1);	
			setTimeout(function(){ $("#cont2_img7").addClass("img7_ani"); },time1);	
			setTimeout(function(){ $("#msg0").addClass("img8_ani"); },time1);	
			setTimeout(function(){ $("#msg1").addClass("img9_ani"); },time1);	
			setTimeout(function(){ $("#msg2").addClass("img10_ani"); },time);	
			setTimeout(function(){ $("#msg3").addClass("img11_ani"); },time);	
			setTimeout(function(){ $("#arrow").addClass("img12_ani"); },time);	
			setTimeout(function(){ $("#cont2_img13").addClass("com_ani_scale_1"); },time1);	
			this.aniCom_MtopOpacity($(".tit-consub0"),"-290px","1",time);	
			break;
			case 3:
			var time=400,time1=1000;
			$("#cont3_img0").addClass("img0_ani");	
			setTimeout(function(){ $("#cont3_img1").addClass("img1_ani"); },time);	
			setTimeout(function(){ $("#cont3_img2").addClass("img2_ani"); },time);	
			setTimeout(function(){ $("#cont3_img3").addClass("img3_ani"); },time);	
			setTimeout(function(){ $("#cont3_img4").addClass("img4_ani"); },time1);	
			setTimeout(function(){ $("#cont3_img5").addClass("img5_ani"); },time1);	
			setTimeout(function(){ $("#cont3_img6").addClass("img6_ani"); },time);	
			setTimeout(function(){ $("#cont3_img7").addClass("img7_ani"); },time);	
			...
			setTimeout(function(){ $("#cont4_img1").addClass("img1_ani"); },time);	
			setTimeout(function(){ $("#cont4_img2").addClass("img2_ani"); },time);	
			setTimeout(function(){ $("#cont4_img3").addClass("img3_ani"); },time);	
			setTimeout(function(){ $("#cont4_img4").addClass("img4_ani"); },time3);	
			setTimeout(function(){ $("#cont4_img5").addClass("img5_ani"); },time3);	
			setTimeout(function(){ $("#cont4_img6").addClass("img6_ani"); },time2);	
			setTimeout(function(){$("#cont4_img6 img").addClass("com_ani_rotate");},1000);	
			setTimeout(function(){ $("#cont4_img8").addClass("img8_ani"); },time2);	
			setTimeout(function(){ $("#cont4_img9").addClass("img9_ani"); },time);	
			setTimeout(function(){ $("#cont4_img9 ul .item2").addClass("item2_ani"); },time4);	
			setTimeout(function(){ $("#cont4_img9 ul .item1").addClass("item1_ani"); },time4+200);	
			setTimeout(function(){ $("#cont4_img9 ul .item0").addClass("item0_ani"); },time4+400);	
