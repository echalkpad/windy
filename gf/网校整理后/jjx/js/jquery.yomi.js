...
$.fn.yomi=function(){
	...
	createdom =function(dom){
		...
		$(_DOM).append("<ul class='yomi'><li class='yomiday'></li><li class='split'></li></ul>")
		reflash();
...
$(function(){
	...
	$("head").append("<style type='text/css'>.yomi {list-style:none;}.yomi li{float:left;color:#ffe971;font-size:20px; font-weight:bold;}.yomi li.split{background:none;color:#ffe971;}</style>")
});